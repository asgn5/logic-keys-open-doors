...
public class Box extends Rectangle {
    ...
    public Box(String itemLeft, String itemAbove, int row, int column, Color answer) {
        super(50, 50);
        this.above = itemAbove;
        this.left = itemLeft;
        this.row = row;
    ...
    public String toString() {
        return String.format("{%12s | %-12s}{%d,%d},{%s}{%s}", left, above, row, column, current(), getColorName(answer));
    }
